...
import WatermelonJSON from "/public/img/coding.json";
    ...
    <nav class="bg-white">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" class="flex items-center">
                <img src="img/logo1.png" class="h-8 mr-3" alt=" Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-dark">nadhira aurell</span>
            </a>
            ...
            <div class="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
                ...
                <div class="flex flex-col justify-center pt-6 sm:flex-row lg:justify-start">
                    <div class="flex items-center justify-center sm:justify-start">
                        <a href="https://www.instagram.com/nadhiraapp_/"
